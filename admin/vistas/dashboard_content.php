...
<?php else: ?>
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <?php foreach ($locales as $local): ?>
            <div
                class="bg-white rounded-2xl border border-gray-200 shadow hover:shadow-md transition p-6 flex flex-col justify-between">
                <!-- Encabezado -->
                <div class="flex justify-between items-start mb-4">
                    <h3 class="text-lg font-semibold text-[#3A1F0F] leading-snug"><?= htmlspecialchars($local['nombre']) ?>
                    </h3>
